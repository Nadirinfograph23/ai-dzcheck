...
var TRANSLATIONS = {
    en: {
        ...
        verdict_uncertain: 'Mixed Results',
        ...
        verdict_uncertain_sub: 'Detection engines show conflicting results — manual verification is recommended',
        ...
        verdict_uncertain_detail: 'Conflicting signals detected across engines. We recommend manual verification. AI probability is',
        ...
        insight_uncertain_title: 'Mixed Detection Results',
        insight_uncertain_desc: 'Detection engines show conflicting results for this {media}. We recommend manual verification to confirm authenticity.',
        media_image: 'image',
        media_video: 'video',
        media_audio: 'audio',
    ...
    ar: {
        ...
        verdict_uncertain: '\u0646\u062a\u0627\u0626\u062c \u0645\u062a\u0636\u0627\u0631\u0628\u0629',
        ...
        verdict_uncertain_sub: '\u062a\u062a\u0636\u0627\u0631\u0628 \u0646\u062a\u0627\u0626\u062c \u0645\u062d\u0631\u0643\u0627\u062a \u0627\u0644\u0643\u0634\u0641 \u2014 \u064a\u0646\u0635\u062d \u0628\u0627\u0644\u062a\u062d\u0642\u0642 \u0627\u0644\u064a\u062f\u0648\u064a',
    ...
    fr: {
        ...
        verdict_uncertain: 'R\u00e9sultats Mixtes',
        ...
        verdict_uncertain_sub: 'Les moteurs de d\u00e9tection montrent des r\u00e9sultats contradictoires \u2014 v\u00e9rification manuelle recommand\u00e9e',
...
async function compareResults(results) {
    ...
    // Final score = simple average of all engine scores
    var allScores = [
    ...
    var verdicts = { ai: 0, real: 0, uncertain: 0, mixed: 0 };
    results.forEach(function(r) {
        var v = r.verdict === 'mixed' ? 'uncertain' : r.verdict;
        verdicts[v] = (verdicts[v] || 0) + 1;
    });
    var agreeing = Math.max(verdicts.ai, verdicts.real, verdicts.uncertain + (verdicts.mixed || 0));

    // Override: if clear majority (13+) engines agree
    if (verdicts.real >= 13 && finalScore < 65) {
        consensus = 'real';
    }
    if (verdicts.ai >= 13 && finalScore >= 40) {
        consensus = 'ai';
    }
    ...
    return {
        ...
        weightsUsed: { method: 'simple_average', engines: allScores.length },
