...
var TRANSLATIONS = {
    en: {
        ...
        verdict_mixed_detail: 'The engines are divided. Some indicate AI-generated while others suggest authentic. AI probability is',
    ...
    ar: {
        ...
        verdict_mixed_detail: 'المحركات منقسمة. بعضها يشير إلى توليد ذكاء اصطناعي وبعضها يشير إلى أصالة. احتمال الذكاء الاصطناعي',
    ...
    fr: {
        ...
        verdict_mixed: 'Résultats Mixtes',
...
function displayResults(comparison, allResults) {
    ...
    // Set verdict (map 'mixed' to its CSS class)
    var verdictBoxClass = comparison.verdict === 'mixed' ? 'uncertain' : comparison.verdict;
    verdictBox.className = 'verdict-box ' + verdictBoxClass;
    
    // Blinking verdict icon: AI, TRUE, mixed, or uncertain
    if (comparison.verdict === 'ai') {
        verdictIcon.innerHTML = '<span class="verdict-badge blink-ai"><i class="fas fa-robot"></i> AI</span>';
    } else if (comparison.verdict === 'mixed') {
        verdictIcon.innerHTML = '<span class="verdict-badge blink-mixed"><i class="fas fa-scale-balanced"></i> MIXED</span>';
    ...
    if (insightBox) {
        ...
        if (comparison.deepfakeDetected) {
            ...
            // Mixed results: engines are divided
